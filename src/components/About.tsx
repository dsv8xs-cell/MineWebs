      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            >
              Мы создали сервер, на котором хотели бы играть сами. Никаких гриферских донатов, гриферов, бесконечных вайпов. Только чистое выживание и фокус на сообществе.
            </motion.p>
            <motion.div 
