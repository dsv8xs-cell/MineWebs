...
const newsItems: NewsItem[] = [
  {
    ...
    date: "20 Июня 2026",
    summary: "Переезд на новый хостинг, переход на SSD, обновление Purpur, прорисовка 20 чанков, оптимизация плагинов и новые механики геймплея.",
    tag: "Глобальное 🚀",
    type: "global_patch"
  }
];
          ...
          <div className="space-y-8 text-zinc-300">
            <div className="bg-emerald-500/10 border border-emerald-500/20 p-5 rounded-2xl space-y-3">
              ...
              <p className="text-sm leading-relaxed text-zinc-200">
                Мы завершили крупное техническое обновление и переработку сервера. Проект переехал на <strong>новый хостинг в Европе (Польша)</strong>, что позволило кардинально снизить пинг и улучшить стабильность соединения для всех игроков. Также сервер успешно перешел на современное ядро <strong>Purpur (версия 1.21.1)</strong>, а также переход на <strong>SSD</strong>, став быстрее и получив множество новых геймплейных механик!
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-zinc-400">Организация вашего инвентаря и сундуков в один клик в любом пустом месте инвентаря с помощью <strong>ChestSort</strong>.</p>
                </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-sm text-zinc-400 list-disc list-inside">
                <li>Обновление производительного ядра <strong className="text-zinc-200">Purpur 1.21.1</strong>.</li>
                <li><strong>Переезд на новый хостинг</strong> — повышенная стабильность, отличный пинг и защищенность, переход на SSD накопители.</li>
                <li><strong>Увеличение дальности прорисовки до 20 чанков</strong> — исследуйте мир с потрясающими видами без потери производительности!</li>
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm">
                Мы бережно сохранили и модернизировали наши основные системы безопасности: авторизация <strong>AuthMe Reloaded</strong>, защита регионов и приватов <strong>WorldGuard</strong>, кроссплатформенный коннектор <strong>Geyser + Floodgate</strong> для Bedrock игроков.
              </p>
            </div>
          </div>
        );
      ...
      case "optimization":
        return (
          <div className="space-y-6 text-zinc-300">
            ...
            <ul className="space-y-2 text-sm text-zinc-400 list-disc list-inside">
              <li>Очищены устаревшие лог-файлы.</li>
              ...
              <li>Скорость отклика сервера в пиковые часы увеличилась.</li>
            </ul>
          </div>
        );
